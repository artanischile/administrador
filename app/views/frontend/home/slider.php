...
<div class="slider-wrap home-1-slider">
	<div id="mainSlider" class="nivoSlider slider-image">
		<img src="<?php echo base_url('assets/frontend/')?>img/slider/01.jpg" alt="main slider" />
		<img src="<?php echo base_url('assets/frontend/')?>img/slider/02.jpg" alt="main slider" />
        <img src="<?php echo base_url('assets/frontend/')?>img/slider/03.jpg" alt="main slider" />
	</div>
